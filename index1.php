...
?>
  ...
  <div class="modal-content">
    <p>Membership is not a barrier to getting involved. The application feels like a game of 21 questions (we know, we're sorry...) but as long as you want to be a part of the Wide Awake Community, we'll find a way to make it happen. We have to ask the questions because understanding you on Day One means we can support you from the minute you join.</p>
...
<div class="formbold-main-wrapper">
  ...
  <div class="formbold-form-wrapper">
    ...
    <form action="function.php" method="POST" id="form_id"  enctype="multipart/form-data">
...
// }
    ...
    function form3(){
      ...
      var input_1 = $("#consent").val();
     
      var input_2 = $("#consent2").val();
